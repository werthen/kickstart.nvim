...
-- Keymap for python files to run the current file in a terminal buffer
vim.keymap.set('n', '<localleader>r', '<cmd>!uv run %<CR>', { desc = 'Run current file' })
...
require('lazy').setup({
  ...
  -- },
  {
    'ledger/vim-ledger', -- This is for hledger support
    version = false,
    ft = 'ledger',
    init = function()
